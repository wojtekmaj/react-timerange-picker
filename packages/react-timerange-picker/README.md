...
| customInputsForm     | `form` attribute for the custom hour, minute, second, and AM/PM inputs. Set to an empty string to exclude these inputs from their nearest ancestor form.                                                                                                                                                                                           | n/a                                   | `"my-form"`                                                                                                                                                                                                                           |
